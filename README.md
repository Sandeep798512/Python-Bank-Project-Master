...
2. Clone the repository:
    ```bash
    git clone (https://sandeep798512.github.io/Python-Bank-Project-Master/)
    ```
...
- 
- [Instagram](https://www.instagram.com/sandeep_8___)
- [LinkedIn](https://www.linkedin.com/in/sandeep-gaud-418b38332)
